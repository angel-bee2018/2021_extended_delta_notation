...
tibble_ref_gtf <- data.table::fread(file = paste(ensembl_GTF_dump_dir, "annotated_ensembl_gtf_release_75.txt", sep = ""), sep = "\t", stringsAsFactors = FALSE, check.names = FALSE, header = TRUE) %>% as_tibble
...
tibble_biomart_regions_gtf <- dplyr::left_join(tibble_biomart_regions_gtf0, tibble_uniprotkb_entry_to_ENSP_mapping) %>% 
  dplyr::left_join(., tibble_hgnc_stable_protein_id_mapping[tibble_hgnc_stable_protein_id_mapping$ensembl_release_version == tibble_hgnc_stable_protein_id_mapping$last_release_seen_gene_protein_id, c("gene_id", "protein_id", "hgnc_stable_protein_ID")]) %>%
...
data.table::fwrite(x = tibble_biomart_regions_gtf, file = paste(results_dir, "biomart_tracks_ensembl_75.txt", sep = ""), sep = "\t", quote = FALSE, col.names = TRUE, row.names = FALSE)
...
data.table::fwrite(x = tibble_biomart_regions_gtf_gene_centric, file = paste(results_dir, "biomart_tracks_gene_centric_ensembl_75.txt", sep = ""), sep = "\t", quote = FALSE, col.names = TRUE, row.names = FALSE)
...
data.table::fwrite(x = tibble_dbPTM_regions_gtf, file = paste(results_dir, "dbPTM_tracks_ensembl_75.txt", sep = ""), sep = "\t", quote = FALSE, col.names = TRUE, row.names = FALSE)
...
data.table::fwrite(x = tibble_dbPTM_regions_gtf_gene_centric, file = paste(results_dir, "dbPTM_tracks_gene_centric_ensembl_75.txt", sep = ""), sep = "\t", quote = FALSE, col.names = TRUE, row.names = FALSE)
