...
tibble_biomart_regions_gtf_gene_centric[tibble_biomart_regions_gtf_gene_centric$region_type == "interpro", "region_type"] <- paste("interpro: ", tibble_biomart_regions_gtf_gene_centric[tibble_biomart_regions_gtf_gene_centric$region_type == "interpro", "ENTRY_NAME"] %>% head, sep = "")
