...
tibble_ENSG_to_latest_ensg_gene_name_combined_mapping <- tibble_hgnc_stable_variant_mapping[, c("gene_id", "latest_ensg_gene_name_combined")] %>% unique

# UNIPARC
data.table::setDTthreads(threads = 66)
## we will order UNIPROT proteins with conflicting ENSG IDs/uniprotkb_id by UNIPARC order.
## IT'S SUPER MASSIVE
list_uniparc_
