...
tibble_interpro_entry_mapping <- list_all_tibble_interpro_entries$`47.0`
...
list_of_tibbles_biomart_regions_cast_onto_genome <- furrr::future_imap(
  ...
  .f = function(a1, a2) {
    ...
    # DEBUG ###
    # a1 <- list_biomart_features$ncoils %>% .[13769, ]
    ###########
    ...
    .f = function(a1, a2) {
      ...
      list_biomart_regions_gtf <- furrr::future_imap(
        ...
        .f = function(b1, b2) {
          ...
          # b1 <- list_biomart_regions_cast_onto_genome_split[[10]][411, ]
          ###########
